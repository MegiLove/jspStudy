...
<form action="form01_process.jsp" method="post">
	...
	<p>성별: <input type="radio" name="sex" value="남성" checked="checked">남성
	   성별: <input type="radio" name="sex" value="여성">여성
	   </p>
	   ...
	   <p>
	   지역: <select name="city" size="3">
	   			<option value="서울시">서울 특별시</option>
	   ...
	   <p>
	   		<textarea name="comment" rows="3" cols="30" placeholder="가입 인사를 입력해 주세요"></textarea>
	   </p>
	   <p>
